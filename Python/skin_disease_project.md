...
- Root Dir: `D:\skin_disease_detection`
...
│   │   │   │   ├── dataset_inspection-checkpoint.ipynb
...
│       ├── Routing.js
│       ├── components
│       │   ├── DiseasePredictorTool.js
│       │   ├── ImageUpload.js
│       │   ├── ImageUpload_Styles.js
│       │   └── ProtectedRoute.js
│       ├── hooks
│       │   └── useSkinDiseasePrediction.js
│       ├── index.css
│       ├── index.js
│       ├── pages
│       │   ├── Dashboard.js
...
### `backend\app\ai_models\densenet121_model.py`
...
### `backend\app\ai_models\efficientnetB3_model.py`
...
### `backend\app\ai_models\resnet101_model.py`
...
### `backend\app\ai_models\__init__.py`

```py
```

### `backend\app\config\mongo_config.py`
...
### `backend\app\db_models\user_model.py`
...
### `backend\app\services\training_ensemble_model_service.py`
...
### `frontend\src\components\DiseasePredictorTool.js`
...
### `frontend\src\components\ImageUpload_Styles.js`
...
### `frontend\src\hooks\useSkinDiseasePrediction.js`
...
### `frontend\src\pages\Dashboard_Styles.js`
...
### `frontend\src\pages\Login_Page.js`
...
### `frontend\src\pages\Signup_Page.js`
...
### `frontend\src\pages\Tool_Page.js`
...
### `frontend\src\services\predictApi.js`
