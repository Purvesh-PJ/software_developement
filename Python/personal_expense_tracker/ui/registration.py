...
def registration_ui():
    ...
    # Title
    title_label = tk.Label(frame, text="signup", font=title_font, bg="#FFFFFF", fg="#333")
    ...
    login_button = tk.Button(frame, text="Submit", font=button_font, bg="#60a5fa", fg="white", bd=0, padx=10, pady=10,
                             width=20, command=register)
